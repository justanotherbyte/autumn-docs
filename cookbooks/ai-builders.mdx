...
import { autumnHandler } from "npm:autumn-js@0.0.55-beta.4/supabase";
...
Now you can describe to the AI the pricing plans you defined in Autumn. Make sure to provide it with the productIds and featureIds (if you're using usage pricing or limits).
